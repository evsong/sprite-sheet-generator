      ...
      <div className="w-full max-w-sm bg-[#0D0D0D] border border-[#1E1E1E] rounded-xl p-8">
        ...
        <div className="space-y-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-[#1A1A1A] border border-[#1E1E1E] rounded-lg text-[12px] text-white hover:bg-[#222] transition-colors duration-150 cursor-pointer"
            >
        ...
        <p className="text-[10px] text-[#444] text-center mt-6 font-[family-name:var(--font-mono)]">
